...
def create_model(model, dataset, algo):
    ...
    return df_worst[["num_parfait_counterfactuals", "total_sampled_points", 'write_file']], df_pareto_optimal_max_score_row[["num_parfait_counterfactuals", "total_sampled_points", 'write_file']], df_pareto_optimal_max_AOD_row[["num_parfait_counterfactuals", "total_sampled_points", 'write_file']]
...
def main():
    ...
    count = 0
    score_dataframe = pd.DataFrame(columns = ["num_parfait_counterfactuals","total_sampled_points",'write_file', 'dataset', 'model', "arr",'optimal'])
