...
python3 main_mutation_custom_masking.py --dataset=census --algorithm=LogisticRegression --sensitive_index=8 --time_out=$1 --output=LR_census_race_mutation --save_model=$2 --max_iter=$3
python3 main_mutation_custom_masking.py --dataset=census --algorithm=TreeRegressor --sensitive_index=8 --time_out=$1 --output=RF_census_race_mutation --save_model=$2 --max_iter=$3
python3 main_mutation_custom_masking.py --dataset=census --algorithm=SVM --sensitive_index=8 --time_out=$1 --output=SV_census_race_mutation --save_model=$2 --max_iter=$3
python3 main_mutation_custom_masking.py --dataset=census --algorithm=Decision_Tree_Classifier --sensitive_index=8 --time_out=$1 --output=DT_census_race_mutation --save_model=$2 --max_iter=$3
